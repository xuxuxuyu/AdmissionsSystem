        ...
        <div class="page-container">
          ...
          <div class="page-operation-box clearfix">
            <div class="pull-left">
              ...
              <el-button 
                type="primary" 
                icon="icon iconfont">审核
              </el-button>
              <el-button 
                type="primary" 
                icon="icon iconfont">手动分专业
              </el-button>
              <el-button 
                type="primary" 
                icon="icon iconfont">自动分班
              </el-button>
              <el-button 
                type="primary" 
                icon="icon iconfont">手动分班
              </el-button>
              <el-button 
                type="primary" 
                icon="icon iconfont">清空班级信息
              </el-button>
              <el-button 
                type="primary" 
                icon="icon iconfont">生成学号
              </el-button>
              <el-button 
                type="primary" 
                icon="icon iconfont">清空学号
              </el-button>
              <el-button 
                type="primary" 
                icon="icon iconfont icondaochu">导出
              </el-button>
            </div>
          </div>
          <!-- 列表 -->
