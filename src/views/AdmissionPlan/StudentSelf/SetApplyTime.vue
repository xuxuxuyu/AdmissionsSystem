    ...
    <div class="page-container">
      ...
      <div class="page-operation-box clearfix">
        <div class="pull-left">
          <el-button 
            type="primary" 
            icon="icon iconfont icon-add" @click="openAdd()">新增
          </el-button>
          <el-button 
            type="primary" 
            icon="icon iconfont"  @click="openUpdate()" :disabled="updateBatchBtnDisabled">修改
          </el-button>
          <el-button
            type="primary"
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope"> 
              <template slot-scope="scope"> {{ scope.row.mt }}</template>
            </template>
          </el-table-column>
          <el-table-column
            show-overflow-tooltip
          ...
          <el-table-column
            ...
            min-width="100">
            <template slot-scope="scope"> 
              <el-checkbox v-model="scope.row.sfktzcj"></el-checkbox>
            </template>
          </el-table-column>
        </el-table>
      </div>
            ...
            <div class="block">
              <el-form
                ...
                <el-form-item label="年份" prop="year">
                  <el-input clearable v-model="editForm.year" placeholder="请输入年份"></el-input>
                </el-form-item>
                <el-form-item label="名头" prop="mt">
                  <el-input clearable v-model="editForm.mt" placeholder="请输入名头"></el-input>
                </el-form-item>
                <el-form-item label="是否可填总成绩" prop="sfktzcj">
                  <el-checkbox v-model="editForm.sfktzcj"></el-checkbox>
                </el-form-item>
                <el-form-item label="标记" prop="bj">
                  <el-checkbox v-model="editForm.bj"></el-checkbox>
                </el-form-item>
              </el-form>
            </div>
          </el-col>
    ...
    methods:{
      saveInfo(){
        this.$refs["editForm"].validate(async valid => {
          ...
          let startTime = new Date(this.editForm.startDate).getTime()
          let endTime = new Date(this.editForm.endDate).getTime() 
