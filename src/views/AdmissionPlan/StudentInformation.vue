<template>
	<!-- 学生信息 -->
	<div class="page-StudentInformation">
    <div class="page-container">
      ...
      <div class="page-operation-box clearfix">
        <div class="pull-left">
            ...
            @click="openEditForm('update')" :disabled="updateBatchBtnDisabled" v-if="btn.update">修改
          </el-button>
          <el-button type="primary" icon="icon iconfont iconshanchu" @click="deleteConfirm('')" :disabled="deleteBatchBtnDisabled" v-if="btn.del">删除</el-button>
          <el-button type="primary" v-if="btn.update">审核通过</el-button>
          <el-button type="primary" v-if="btn.update">取消审核</el-button>
          <el-button type="primary" v-if="btn.update">手动分专业</el-button>
          <el-button type="primary" v-if="btn.update">自动分专业</el-button>
          <el-button type="primary" v-if="btn.update">生成学号</el-button>
          <el-button type="primary" v-if="btn.update">生成序号</el-button>
          <el-button type="primary" v-if="btn.update">清空序号</el-button>
          <el-button type="primary" v-if="btn.update">生成密码</el-button>
          <el-button type="primary" v-if="btn.update">批量修改</el-button>
...
<script>
    ...
    computed: {
      USER_INFO() {
        ...
        requestSuffix:{
          select:'/rsSmxsjbxx/getList.action',
        },
        selectConfig: {
          // 表格的通用请求
          table: {
