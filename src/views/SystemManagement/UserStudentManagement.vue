<template>
    <!-- 学生用户管理 -->
    <div class="page-UserStudentManagement">
          ...
          <div class="pull-left">
            ...
            <div class="cascade-select">
              <el-form :inline="true" :model="dataBase" class="demo-form-inline">
                <el-form-item class="lab" label="学生姓名/一卡通号:">
...
<style>
  .page-UserStudentManagement{
    position: relative;
    text-align: left;
  }
  .page-UserStudentManagement .cascade-select .el-form-item__label{
    width: 130px;
  }
</style>